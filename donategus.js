...
function closePaymentModal() {
    ...
    // If user pressed X button (not back), pop the state we pushed
    if (history.state && history.state.modal === 'payment') {
        history.back();
    }
}

// Hardware / browser back button → close modal instead of leaving page
